...
public class ProjectStudy2 {
    ...
    public ProjectStudy2() {
    }

    public ProjectStudy2(String projectPath) {
    ...
    public void run() {
        ...
        for (Project project : projects) {
            try {
                ...
                ProjectStudy2 projectStudy2 = new ProjectStudy2(project.getLocalAddress());
                System.out.println(project.getLocalAddress());
                System.out.println("The project has " + projectStudy2.getJavaFilesPath().size() + "classes!");
                if (projectStudy2.getJavaFilesPath().size() > 2000)
                    continue;
                projectStudy2.invokeCount();
    ...
    public void run2() {
        ProjectStudy2 projectStudy2 = new ProjectStudy2("/Users/xiyaoguo/Desktop/code");
        System.out.println(projectStudy2.invokeCount());
        String idsString = projectStudy2.getIds().stream().map(Object::toString).collect(Collectors.joining(","));
        System.out.println("ids : " + idsString);
        //FileUtil.write("/home/fdse/xyy/study/ids", idsString);
    }

    public static void main(String[] args) {
        new ProjectStudy2().run();
