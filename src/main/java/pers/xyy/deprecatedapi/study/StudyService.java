...
public class StudyService {
    ...
    private final static String search = "select id,repos_name,local_addr from repository_java where stars_count >= 500 and stars_count < 1000 and master_host=84 and primaryLanguage='Java'";
