...
public class StudyService {
    ...
    private final static String search = "select id,repos_name,local_addr from repository_java where stars_count>=100 and stars_count<500 and master_host=81 and primaryLanguage='Java' and is_downloaded=1";
