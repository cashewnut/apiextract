...
public class StudyService {
    ...
    private final static String search = "select id,repos_name,local_addr from repository_java where stars_count>=1000 and master_host=84 and primaryLanguage='Java' and is_downloaded=1 and id>35657";
